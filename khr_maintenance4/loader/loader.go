package khr_maintenance4_loader

//go:generate go run go.uber.org/mock/mockgen -source loader.go -destination ../mocks/loader.go -package mock_maintenance4
...
type Loader interface {
	VkGetDeviceBufferMemoryRequirementsKHR(device loader.VkDevice, pInfo *VkDeviceBufferMemoryRequirementsKHR, pMemoryRequirements *loader.VkMemoryRequirements2)
	VkGetDeviceImageMemoryRequirementsKHR(device loader.VkDevice, pInfo *VkDeviceImageMemoryRequirementsKHR, pMemoryRequirements *loader.VkMemoryRequirements2)
	VkGetDeviceImageSparseMemoryRequirementsKHR(device loader.VkDevice, pInfo *VkDeviceImageMemoryRequirementsKHR, pSparseMemoryRequirementCount *loader.Uint32, pSparseMemoryRequirements *loader.VkSparseImageMemoryRequirements2)
}
...
func CreateLoaderFromCore(coreLoader loader.Loader) *CLoader {
	...
	return &CLoader{
		...
		getDeviceBufferMemoryRequirementsKHR:      (C.PFN_vkGetDeviceBufferMemoryRequirementsKHR)(coreLoader.LoadProcAddr((*loader.Char)(arena.CString("vkGetDeviceBufferMemoryRequirementsKHR")))),
		getDeviceImageMemoryRequirementsKHR:       (C.PFN_vkGetDeviceImageMemoryRequirementsKHR)(coreLoader.LoadProcAddr((*loader.Char)(arena.CString("vkGetDeviceImageMemoryRequirementsKHR")))),
		getDeviceImageSparseMemoryRequirementsKHR: (C.PFN_vkGetDeviceImageSparseMemoryRequirementsKHR)(coreLoader.LoadProcAddr((*loader.Char)(arena.CString("vkGetDeviceImageSparseMemoryRequirementsKHR")))),
	}
}

func (d *CLoader) VkGetDeviceBufferMemoryRequirementsKHR(device loader.VkDevice, pInfo *VkDeviceBufferMemoryRequirementsKHR, pMemoryRequirements *loader.VkMemoryRequirements2) {
...
func (d *CLoader) VkGetDeviceImageMemoryRequirementsKHR(device loader.VkDevice, pInfo *VkDeviceImageMemoryRequirementsKHR, pMemoryRequirements *loader.VkMemoryRequirements2) {
...
func (d *CLoader) VkGetDeviceImageSparseMemoryRequirementsKHR(device loader.VkDevice, pInfo *VkDeviceImageMemoryRequirementsKHR, pSparseMemoryRequirementCount *loader.Uint32, pSparseMemoryRequirements *loader.VkSparseImageMemoryRequirements2) {
