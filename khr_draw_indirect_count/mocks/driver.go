...
//
//	mockgen -source driver.go -destination ../mocks/driver.go -package mock_draw_indirect_count
//
...
func (mr *MockDriverMockRecorder) VkCmdDrawIndexedIndirectCountKHR(commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride any) *gomock.Call {
...
func (mr *MockDriverMockRecorder) VkCmdDrawIndirectCountKHR(commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
