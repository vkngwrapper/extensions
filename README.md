...
[![Go Reference](https://pkg.go.dev/badge/github.com/vkngwrapper/extensions.svg)](https://pkg.go.dev/github.com/vkngwrapper/extensions)
...
Once you've gotten the hang of the core library, you may wish to make use of one of Vullkan's many extensions. This
 ...
 can be accessed via the package name, usch as [khr_imageless_framebuffer.FramebufferAttachmentImageInfo](https://pkg.go.dev/github.com/vkngwrapper/extensions@v0.2.1/khr_imageless_framebuffer#FramebufferAttachmentImageInfo)
 or [khr_sampler_mirror_clamp_to_edge.SamplerAddressModeMirrorClampToEdge](https://pkg.go.dev/github.com/vkngwrapper/extensions@v0.2.1/khr_sampler_mirror_clamp_to_edge#pkg-constants).
