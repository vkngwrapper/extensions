...
type ExtensionDriver interface {
	...
	GetPhysicalDeviceSurfaceSupport(surface Surface, physicalDevice core.PhysicalDevice, queueFamilyIndex int) (bool, common.VkResult, error)
	...
	GetPhysicalDeviceSurfaceCapabilities(surface Surface, device core.PhysicalDevice) (*SurfaceCapabilities, common.VkResult, error)
	...
	GetPhysicalDeviceSurfaceFormats(surface Surface, device core.PhysicalDevice) ([]SurfaceFormat, common.VkResult, error)
	...
	GetPhysicalDeviceSurfacePresentModes(surface Surface, device core.PhysicalDevice) ([]PresentMode, common.VkResult, error)
}
