...
//
//	mockgen -source surface.go -destination ./mocks/surface.go -package mock_surface
//
...
func (mr *MockSurfaceMockRecorder) PhysicalDeviceSurfaceCapabilities(device any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSurfaceMockRecorder) PhysicalDeviceSurfaceFormats(device any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSurfaceMockRecorder) PhysicalDeviceSurfacePresentModes(device any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSurfaceMockRecorder) PhysicalDeviceSurfaceSupport(physicalDevice, queueFamilyIndex any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
