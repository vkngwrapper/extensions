...
// MockDriver is a mock of Loader interface.
...
func (mr *MockDriverMockRecorder) VkAcquireNextImageKHR(device, swapchain, timeout, semaphore, fence, pImageIndex any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDriverMockRecorder) VkCreateSwapchainKHR(device, pCreateInfo, pAllocator, pSwapchain any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDriverMockRecorder) VkDestroySwapchainKHR(device, swapchain, pAllocator any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDriverMockRecorder) VkGetSwapchainImagesKHR(device, swapchain, pSwapchainImageCount, pSwapchainImages any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDriverMockRecorder) VkQueuePresentKHR(queue, pPresentInfo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
