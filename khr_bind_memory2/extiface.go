...
type Extension interface {
	...
	BindBufferMemory2(device core.Device, options []BindBufferMemoryInfo) (common.VkResult, error)
	...
	BindImageMemory2(device core.Device, options []BindImageMemoryInfo) (common.VkResult, error)
}
