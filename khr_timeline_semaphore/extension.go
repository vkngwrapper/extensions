...
func CreateExtensionDriverFromLoader(driver khr_timeline_semaphore_loader.Loader, device core1_0.Device) *VulkanExtensionDriver {
	return &VulkanExtensionDriver{
		driver: driver,
		device: device,
	}
...
func (e *VulkanExtensionDriver) GetSemaphoreCounterValue(semaphore core1_0.Semaphore) (uint64, common.VkResult, error) {
