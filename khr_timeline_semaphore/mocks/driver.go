...
//
//	mockgen -source driver.go -destination ../mocks/driver.go -package mock_timeline_semaphore
//
...
func (mr *MockDriverMockRecorder) VkGetSemaphoreCounterValueKHR(device, semaphore, pValue any) *gomock.Call {
...
func (mr *MockDriverMockRecorder) VkSignalSemaphoreKHR(device, pSignalInfo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDriverMockRecorder) VkWaitSemaphoresKHR(device, pWaitInfo, timeout any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
