...
func (mr *MockDriverMockRecorder) VkCmdBeginRenderPass2KHR(commandBuffer, pRenderPassBegin, pSubpassBeginInfo any) *gomock.Call {
...
func (mr *MockDriverMockRecorder) VkCmdEndRenderPass2KHR(commandBuffer, pSubpassEndInfo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDriverMockRecorder) VkCmdNextSubpass2KHR(commandBuffer, pSubpassBeginInfo, pSubpassEndInfo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDriverMockRecorder) VkCreateRenderPass2KHR(device, pCreateInfo, pAllocator, pRenderPass any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
