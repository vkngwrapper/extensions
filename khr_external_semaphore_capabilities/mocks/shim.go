...
//
//	mockgen -source shim.go -destination ../mocks/shim.go -package mock_external_semaphore_capabilities
//
...
func (mr *MockShimMockRecorder) ExternalSemaphoreProperties(o, outData any) *gomock.Call {
